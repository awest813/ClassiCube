...
- `misc/dreamcast/IP.BIN` — generate with [makeip](https://github.com/Dreamcast-Projects/makeip): `makeip misc/dreamcast/ip.txt misc/dreamcast/IP.BIN -l misc/dreamcast/boot_logo.png`
